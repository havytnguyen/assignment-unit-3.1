...
let favoriteFoods = ['pasta', 'pho', 'tacos', 'pizza'];
...
let number0fFoods = foodArray.length
console.log(number0fFoods);
...
console.log('added dessert to end of favorite foods', dessertArray);
...
let entreeToUnshift = 'pho';
favoriteFoods.unshift(entree);
console.log('added my favorite entree to favorite foods', favoriteFoods);
...
let lastColor = colorsArray.pop();
console.log('removed the last color', removedlastColor);
console.log('updated variable', colors);
...
console.log('the new colors array', colors);
